    ...
    <div className="scene-selector">
      <div className="scene-selector-top">
        ...
        <div className="scene-global-actions">
          <button className="scene-action-btn" onClick={() => onSceneCopy(activeIndex)} title="Copy Active Scene">
            Copy
          </button>
          <button className="scene-action-btn" onClick={() => onScenePaste(activeIndex)} title="Paste to Active Scene">
            Paste
          </button>
